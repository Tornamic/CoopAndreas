#if !defined(_COOPSERVER_VEHICLE_VEHICLEPACKETS_H_) || !defined(_COOPSERVER_CVEHICLEPACKETS_H_)
#define _COOPSERVER_VEHICLE_VEHICLEPACKETS_H_
#define _COOPSERVER_CVEHICLEPACKETS_H_
