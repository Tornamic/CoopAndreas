...
2. Download **[latest version of plugin-sdk](https://github.com/DK22Pac/plugin-sdk/)** and install it using **[this instruction](https://github.com/DK22Pac/plugin-sdk/wiki/Set-up-plugin-sdk)**.  
